    ...
    <div class="h-screen flex items-center justify-center w-full bg-yellow-50">
        <div class="bg-white shadow-2xl rounded-xl px-8 py-6 max-w-md w-full transform transition-all duration-300 hover:scale-[1.01] animate-fade-in">
            ...
            <form method="post" class="space-y-6">
                <div>
                    <label for="phone" class="block text-sm font-medium text-rose-900 mb-2">
                        Phone Number
                    </label>
                    <input
                        type="tel"
                ...
                <div class="flex justify-end">
                    <a href="sign-in.php" class="font-semibold text-rose-800 hover:text-rose-600 transition-colors duration-300">
                        Create Account
                    </a>
                </div>
